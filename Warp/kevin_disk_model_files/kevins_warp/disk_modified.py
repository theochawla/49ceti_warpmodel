...
#    mDCO    = mCO+2.014               # - HCO molecular weight
    ...
    def set_params(self,params):
        ...
        self.Rin = params[3]*Disk.AU        # - inner edge in Au
        self.Rout = params[4]*Disk.AU       # - outer edge in Au
        self.Rc = params[5]*Disk.AU         # - critical radius in Au
        ...
        self.thet2 = 0
        self.costhet2 = np.cos(self.thet2)
        self.sinthet2 = np.sin(self.thet2)
        self.inin = []
    ...
    def set_structure(self,exp_temp=False):
        ...
        rmin = self.Rin       # - minimum r [cm]
        rmax = self.Rout      # - maximum r [cm]
    ...
    def get_params(self):
        ...
        params.append(math.degrees(self.thet2))
        return params
