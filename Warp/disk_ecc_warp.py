...
#        tempg = tmid*np.exp(np.log(tatm/tmid)*zcf/zq)
    ...
    def set_rt_grid(self):
        ...
        tdiskY = (y_full_rt_grid*self.costhet - z_full_rt_grid*self.sinthet)
        tdiskZ = (y_full_rt_grid*self.sinthet - z_full_rt_grid*self.costhet)
