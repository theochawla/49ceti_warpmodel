...
#    def __init__(self,params=[-0.5,0.09,1.,10.,1000.,150.,51.5,2.3,1e-4,0.01,33.9,19.,69.3,-1,0,0,[.76,1000],[10,800]],obs=[180,131,300,170],rtg=True,vcs=True,line='co',ring=None):
    ...
    def set_structure(self):
        ...
        x_w, y_w, z_w = matrix_mine(self, xi, yi, zcf, warp_i, twist_i, self.thet, 0)
...
#dm[0] = 0
        ...
        self.zf_w = np.linspace(-self.z_w_max, self.z_w_max, nzc)
        ...
        zind_w = np.interp(z_w.flatten(), self.zf_w,range(nzc), right=nzc)
