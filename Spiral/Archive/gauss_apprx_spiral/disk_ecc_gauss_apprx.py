...
#    def __init__(self,params=[-0.5,0.09,1.,10.,1000.,150.,51.5,2.3,1e-4,0.01,33.9,19.,69.3,-1,0,0,[.76,1000],[10,800]],obs=[180,131,300,170],rtg=True,vcs=True,line='co',ring=None):
    def __init__(self,q=-0.5,McoG=0.09,pp=1.,Ain=10.,Aout=1000.,Rc=150.,incl=51.5,
                 ...
                 nr=180,nphi=131,nz=300,zmax=170,rtg=True,vcs=True,line='co',ring=None, h0=1):
        
        params=[q,McoG,pp,Ain,Aout,Rc,incl,Mstar,Xco,vturb,Zq0,Tmid0,Tatm0,handed,ecc,aop,sigbound,Rabund,h0]
        obs=[nr,nphi,nz,zmax]
        #tb = time.clock()
        self.ring=ring
    ...
    def set_params(self,params):
        ...
        self.h0 = params[18]               # - multiplicative factor for scale height of disk (set in calc_hydrostatic)
    ...
    def set_structure(self):
        ...
        tempg = tatm + (tmid-tatm)*np.cos((np.pi/(2*zq))*zcf)**(2.*delta)
                     ...
                     # shape parameter
        #using debris disk definition of temperature
        '''
